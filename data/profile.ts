export const personalInfo = {
  ...
  cgpa: "9.20/10",
  bio: "Aerospace engineering student at IIT Madras researching combustion instability, thermoacoustics, and fluid mechanics. Experienced in experimental methodologies (PIV, low-pressure analog environments) and numerical modeling (CFD, finite-volume solvers). Currently researching pattern formation during transition routes to instability in turbulent combustion."
};
...
export const publications = [
  ...
  },
  {
    ...
    authors: "Bhadra Sreelatha, Rohit Radhakrishnan, R. I. Sujith",
    venue: "International Conference on Vibro-acoustics and Mechano-materials (ICVAM) 2026 [Oral], Conference on Nonlinear Systems and Dynamics (CNSD) 2026 [Poster], Inter Group Meeting (IGM) 2026 [IIT Bombay, Oral, session chair]"
  }
];
...
export const coursework = [
  "Computational Fluid Dynamics (CFD)", "Control Systems", "Introduction to Multiphase-Flows", "Introduction to Turbulence", "Acoustic instabilities in aerospace propulsion", "Combustion & flow diagnostics", "Propulsion for Aircraft and Rocket Systems", "Signals & Systems", "Structural dynamics & Aeroelasticity", "Unsteady Aerodynamics", "Complex Analysis & Transformation Techniques"
];
